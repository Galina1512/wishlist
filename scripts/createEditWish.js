...
export const createEditWish = async (id) => {
   ...
   const labelTitile = createElement('label', {
   ...
   const labelCurrency = createElement('label', {
    className: 'edit__label edit__label-select edit__label_price',
   });

   const selectCurrency = createElement('select', {
    className: 'edit__select edit__select_currency edit__input',
    name: 'carrency',
   });
   ...
   labelLink.append(labelTextLink, inputLink);
    ...
    editwish.append(labelTitile, labelCategory, priceWrapper, labelLink);
    ...
    const inputPhoto = createElement('input', {
        ...
        accept: 'image/jpg, imag/png',
    });

    labelPhoto.append(photo, inputPhoto);

    const btnPhotoDelete = createElement('btn', {
